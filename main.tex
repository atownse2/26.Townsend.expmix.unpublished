...
A foundational result in EVT, the Pickands--Balkema--de Haan theorem, states that for a broad class of underlying probability distributions, the distribution of these threshold excesses asymptotically converges to the Generalized Pareto Distribution (GPD) as the threshold $u$ becomes large. The GPD density is given by:
\begin{equation}
